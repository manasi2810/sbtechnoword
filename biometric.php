                ...
                <div class="row h-100 align-items-center">
                    <div class="col-12" >
                        <nav aria-label="breadcrumb" class="breadcumb--con text-center">
                            <h2 class="w-text title wow fadeInUp" data-wow-delay="0.2s">BIOMETRIC</h2>
                            <ol class="breadcrumb justify-content-center wow fadeInUp" data-wow-delay="0.4s">
                                <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                                <li class="breadcrumb-item"><a href="products.html">Product</li>
                ...
                <div class="col-12"> 
                 ...
                 <div class="col-12 col-md-3"> 
                   <div class="service_single_content text-center mb-100 fadeInUp" style="padding: 10px 10px;" data-wow-delay="0.2s">
                            <div>
                                <img src="img/products/biometric.jpg"  alt="">
                            </div><br>
                              <h6>Biometric</h6>
                            </div>
                </div>
